...
mkdir -p ${TMP}/1024
cat <<EOF > ${TMP}/1024/submit_job${SEEDS}
#!/bin/bash
#SBATCH -N 1
...
#SBATCH -t 00:20:00
#SBATCH -o ${TMP}/1024/outputfile-${SEEDS}_%a
#SBATCH -e ${TMP}/1024/errorfile-${SEEDS}_%a
#SBATCH -J seed${SEEDS}
#SBATCH --array=${SEEDS}
...
DIROUT=${TMP}/1024/seed\${SEED}
mkdir -p \${DIROUT}

echo "DIST:      LOGNORMAL
RNDSEED:   \${SEED}
POISSON:   1
NSIDE:     1024" >> \${DIROUT}/tmpfile
...
sbatch ${TMP}/1024/submit_job${SEEDS}
