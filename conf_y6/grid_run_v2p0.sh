...
SEEDS=${1}
#QUEUE=${2:-debug}
TMP=${3:-$(mktemp --tmpdir=${HOME}/3x2hs_measurements/tmp -d)}
mkdir -p ${HOME}/3x2hs_measurements/tmp

#module load miniconda/3
micromamba activate /store/hcamacho/micromamba
...
# LJF - grid unesp job-nanny requirements
export INPUT="run.sh  conf_y6  flask.yml  flask.py  3x2test.py"
export OUTPUT="*"
